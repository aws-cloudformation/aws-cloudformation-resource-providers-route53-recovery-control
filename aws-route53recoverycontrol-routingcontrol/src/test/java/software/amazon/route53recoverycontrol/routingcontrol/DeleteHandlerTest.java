...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final ResourceModel model = ResourceModel.builder()
                .routingControlArn("thisIsRoutingControlArn")
                .build();
        ...
        final DeleteRoutingControlResponse deleteResponse = DeleteRoutingControlResponse.builder().build();

        doReturn(deleteResponse)
                .doThrow(Route53RecoveryControlConfigException.builder().statusCode(404).build())
                .when(proxy)
