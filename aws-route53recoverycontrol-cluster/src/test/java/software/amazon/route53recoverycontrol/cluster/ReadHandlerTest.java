...
public class ReadHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        assertThat(response.getResourceModel().getClusterArn()).isEqualTo(request.getDesiredResourceState().getClusterArn());
        assertThat(response.getResourceModel().getStatus()).isEqualTo(request.getDesiredResourceState().getStatus());
