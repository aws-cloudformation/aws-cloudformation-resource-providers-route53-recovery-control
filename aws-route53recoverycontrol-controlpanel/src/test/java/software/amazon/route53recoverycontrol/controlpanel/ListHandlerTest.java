...
public class ListHandlerTest {
    ...
    @BeforeEach
    public void setup() {
        proxy = spy(mock(AmazonWebServicesClientProxy.class));
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        controlPanels.add(
                ControlPanel.builder()
                        .name("myFirstCOntrolPanel")
                        .status("DEPLOYED")
                        .routingControlCount(1)
                        .defaultControlPanel(true)
                        .clusterArn("djfhnakldjfaksf")
                        .build()
        );

        ListControlPanelsResponse listResponse = ListControlPanelsResponse.builder().controlPanels(controlPanels).build();
